...
function App() {
  ...
  const springDownRight = useSpring({
    from: { scale: 1 },
    to: { scale: downRightPressed ? 0.8 : 1, transform: "rotate(110deg)" },
  });
  const springDownLeft = useSpring({
    from: { scale: 1 },
    to: { scale: downLeftPressed ? 0.8 : 1, transform: "rotate(-110deg)" },
  });
  const springDown = useSpring({
    from: { scale: 1 },
    to: { scale: downPressed ? 0.8 : 1, transform: "rotate(-180deg)" },
  });
  const springTopRight = useSpring({
    from: { scale: 1 },
    to: { scale: topRightPressed ? 0.8 : 1, transform: "rotate(35deg)" },
  });
  const springTopLeft = useSpring({
    from: { scale: 1 },
    to: { scale: topLeftPressed ? 0.8 : 1, transform: "rotate(-35deg)" },
  });
      ...
      >
        <div className="shell rotator">
          <div className="base">
            ...
            ></div>
            <div className="bar n0">
              <li></li>
            </div>
            <div className="bar n1">
              <li></li>
            </div>
            <div className="bar n2">
              <li></li>
            </div>
            <div className="bar n3">
              <li></li>
            </div>
            <div className="bar n4">
              <li></li>
            </div>
            <div className="overbar n0">
              <li></li>
            </div>
            <div className="overbar n1">
              <li></li>
            </div>
            <div className="overbar n2">
              <li></li>
            </div>
            <div className="overbar n3">
              <li></li>
            </div>
            <div className="overbar n4">
              <li></li>
            </div>
          </div>
        </div>
        <div className="buttonContainer rotator">
          ...
          >
            <animated.button
              ...
              onClick={(e) => handleClick("down", e.target)}
            ></animated.button>
          </animated.section>
          <animated.section
        ...
        <div
          style={{ visibility: `${colorPickDisplayed ? "initial" : "hidden"}` }}
        >
