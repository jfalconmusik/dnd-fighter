...
1) Go to Google Classroom (you will find the link pinned at the top of the classroom Slack channel).

2) Submit the two files that contain the answers to the HW problems for the evening.

3) In future homework submissions you will be submitting the link to your solutions in your GHE repositories.
---
