...
* Go to `View -> Command Palette -> Install 'code' Command`
	* this allows you to open VS Code using a terminal command
* Close VS Code
* From inside the `w01d01_student_examples` directory, open VS Code from the command line with `code .` (code space dot)
